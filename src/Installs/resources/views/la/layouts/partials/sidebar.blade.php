    ...
    <section class="sidebar">
        ...
        <form action="#" method="get" class="sidebar-form">
            <div class="input-group">
	                <input type="text" name="q" class="form-control" placeholder="@lang('global.search')..."/>
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="{{ url(config('laraadmin.adminRoute')) }}"><i class='fa fa-home'></i> <span>@lang('global.dashboard')</span></a></li>
            <?php
