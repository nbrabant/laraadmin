        ...
        <div class="login-box-body">
            ...
            <form action="{{ url('/password/email') }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8">
                        <button type="submit" class="btn btn-primary btn-block btn-flat">@lang('auth.password_reset_link')</button>
                    </div><!-- /.col -->
                    <div class="col-xs-2">
                    </div><!-- /.col -->
                </div>
            ...
            <a href="{{ url('/login') }}">@lang('auth.login')</a><br>
