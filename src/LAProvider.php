...
class LAProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        */
		...
		// Backpack Route Input Maker
        Blade::directive('input_route', function($expression) {
            return "<?php echo LAFormMaker::input_route($expression); ?>";
        });
        ...
        */
        ...
        $commands = [
            ...
            \Dwij\Laraadmin\Commands\LAUpdate::class,
        ];
